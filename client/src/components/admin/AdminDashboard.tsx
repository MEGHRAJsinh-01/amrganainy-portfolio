                    ...
                    <div className="w-full md:w-64 bg-gray-800 rounded-lg p-4">
                        ...
                        <nav className="space-y-1">
                            ...
                            <button
                                ...
                                className={`w-full text-left px-4 py-2 rounded-md transition-colors ${activeTab === 'portfolios' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`w-full text-left px-4 py-2 rounded-md transition-colors ${activeTab === 'settings' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700'
                                    }`}
                            >
                                System Settings
                            </button>
